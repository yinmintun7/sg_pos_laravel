...
@section('content')
    @if (@isset($id))
        <div class="container-fluid receipt category-pg" ng-app="myApp" ng-controller="myCtrl"
            ng-init="init({{ $id }})">
                ...
                <div class="row category">
                    <div class="col-md-12 cat-list" id="cathome">
                        <div class="cat-ttl">
                            ...
                            <input type="text" class="item-search" ng-model="search_item" ng-change="itemSearch()">
    ...
    @if (@isset($id))
        <script src="{{ asset('asset/js/page/order_edit.js?v=20240215') }}"></script>
    @else
