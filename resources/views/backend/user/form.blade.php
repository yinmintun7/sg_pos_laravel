                    ...
                    <div class="x_panel">
                        ...
                        <div class="">
                            @if (@isset($user))
                                ...
                                @else
                                    <form class="" action="{{ route('store') }}" method="POST" novalidate>
                            @endif
                            @csrf
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select id="usertype" name="usertype" class="select2_group form-control">
                                        <option value=""></option>
                                        <option value="admin"
                                            {{ old('usertype', isset($user) && $user->usertype == 'admin') ? 'selected' : '' }}>
                                            Admin</option>
                                        @if (old('usertype') !== 'admin')
                                            <option value="cashier"
                                                {{ old('usertype', isset($user) && $user->usertype == 'cashier') ? 'selected' : '' }}>
                                                Cashier</option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="name" class="form-control" name="username"
                                        value="{{ old('username', isset($category) ? $category->name : '') }}" />
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="password" class="form-control" name="password"
                                        value="{{ old('password', isset($category) ? $category->password : '') }}" />
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="confirm_password" class="form-control" name="confirm_password"
                                        value="{{ old('confirm_password', isset($category) ? $category->confirm_password : '') }}" />
                                </div>
