<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-cart-plus" aria-hidden="true"></i><span>SG-POS</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-history" aria-hidden="true"></i> Shift <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-cubes" aria-hidden="true"></i> Item <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ url('/sg-backend/item/') }}">Create</a></li>
                            <li><a href="{{ url('/sg-backend/item/list') }}">list</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-percent" aria-hidden="true"></i> Promotion <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li><a><i class="fa fa-cog" aria-hidden="true"></i>Setting <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
